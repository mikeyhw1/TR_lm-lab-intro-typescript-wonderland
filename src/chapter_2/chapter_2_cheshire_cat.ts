...
const EXPRESSIONS = ["☹ Frown ☹", "🙂 Smile 🙂", "😁 Grin 😁", "😶 Blank Face 😶", "😡 Angry Face 😡"] as const; // 💡 CURIOUS - see activity_2.md for explanations
...
export function meetTheCheshireCat(): void {
    ...
    print(`You can see ${theCat.name}. A wide ${theCat.expression} is hovering in the air.`);

    if (theCat.expression === "😁 Grin 😁") {
        print(`🥳 The cat allows you to continue onwards. There is the sound of a party in the distance... 🥳 `);
